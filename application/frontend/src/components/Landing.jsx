import React, { Component, useState, Box, Flex, ImageBackground, View, Text } from "react";
...
const Landing = () => {
  return (
    ...
    <figure className="position-relative">
      <img src={Background} alt="bg" className="img-fluid" style={{ filter: 'brightness(30%)', width: '100%', height: '740px' }} />
      <figcaption className='banner'>
        Welcome to Sync!
        </figcaption>
      <figcaption className='subtext1'>
        Share your spotify songs in one of our listening rooms!<br />
